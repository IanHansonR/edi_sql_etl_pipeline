/*
    Stored Procedure: usp_Parse_Arula_KN_StyleColorSizeReport
    Purpose: Parse Arula KN EDI 850 orders from EDIGatewayInbound and populate StyleColorSize Report tables
