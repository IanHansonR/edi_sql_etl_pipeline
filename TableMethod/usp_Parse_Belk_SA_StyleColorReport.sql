/*
    Stored Procedure: usp_Parse_Belk_SA_StyleColorReport
    Purpose: Parse Belk SA (Store Allocation) EDI 850 orders from EDIGatewayInbound and populate StyleColor Report tables
...
CREATE OR ALTER PROCEDURE dbo.usp_Parse_Belk_SA_StyleColorReport
AS
BEGIN
    SET NOCOUNT ON;
