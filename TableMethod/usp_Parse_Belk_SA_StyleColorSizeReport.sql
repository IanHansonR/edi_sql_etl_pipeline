/*
    Stored Procedure: usp_Parse_Belk_SA_StyleColorSizeReport
    Purpose: Parse Belk SA (Store Allocation) EDI 850 orders from EDIGatewayInbound and populate StyleColorSize Report tables
...
CREATE OR ALTER PROCEDURE dbo.usp_Parse_Belk_SA_StyleColorSizeReport
AS
BEGIN
    SET NOCOUNT ON;
