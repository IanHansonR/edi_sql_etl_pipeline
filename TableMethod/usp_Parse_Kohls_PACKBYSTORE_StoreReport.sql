/*
    Stored Procedure: usp_Parse_Kohls_PACKBYSTORE_StoreReport
    Purpose: Parse Kohl's PACK BY STORE EDI 850 orders from EDIGatewayInbound and populate Store Report tables
...
CREATE OR ALTER PROCEDURE dbo.usp_Parse_Kohls_PACKBYSTORE_StoreReport
AS
BEGIN
    SET NOCOUNT ON;
