/*
    Stored Procedure: usp_Parse_Belk_SA_StoreReport
    Purpose: Parse Belk SA (Store Allocation) EDI 850 orders from EDIGatewayInbound and populate Store Report tables
...
CREATE OR ALTER PROCEDURE dbo.usp_Parse_Belk_SA_StoreReport
AS
BEGIN
    SET NOCOUNT ON;
