/*
    Stored Procedure: usp_Parse_Kohls_BULK_StyleColorSizeReport
    Purpose: Parse Kohl's BULK EDI 850 orders from EDIGatewayInbound and populate StyleColorSize Report tables
...
CREATE OR ALTER PROCEDURE dbo.usp_Parse_Kohls_BULK_StyleColorSizeReport
AS
BEGIN
    SET NOCOUNT ON;
