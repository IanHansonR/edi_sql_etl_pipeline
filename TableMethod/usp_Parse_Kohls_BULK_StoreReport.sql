/*
    Stored Procedure: usp_Parse_Kohls_BULK_StoreReport
    Purpose: Parse Kohl's BULK EDI 850 orders from EDIGatewayInbound and populate Store Report tables
...
CREATE OR ALTER PROCEDURE dbo.usp_Parse_Kohls_BULK_StoreReport
AS
BEGIN
    SET NOCOUNT ON;
