/*
    Stored Procedure: usp_Parse_Arula_SA_DetailsReport
    Purpose: Parse Arula SA EDI 850 orders from EDIGatewayInbound and populate Details Report tables
...
CREATE OR ALTER PROCEDURE dbo.usp_Parse_Arula_SA_DetailsReport
AS
BEGIN
    SET NOCOUNT ON;
