/*
    Stored Procedure: usp_Parse_Arula_SA_StoreReport
    Purpose: Parse Arula SA EDI 850 orders from EDIGatewayInbound and populate Store Report tables
...
CREATE OR ALTER PROCEDURE dbo.usp_Parse_Arula_SA_StoreReport
AS
BEGIN
    SET NOCOUNT ON;
