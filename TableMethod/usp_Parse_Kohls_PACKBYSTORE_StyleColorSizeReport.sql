/*
    Stored Procedure: usp_Parse_Kohls_PACKBYSTORE_StyleColorSizeReport
    Purpose: Parse Kohl's PACK BY STORE EDI 850 orders from EDIGatewayInbound and populate StyleColorSize Report tables
...
CREATE OR ALTER PROCEDURE dbo.usp_Parse_Kohls_PACKBYSTORE_StyleColorSizeReport
AS
BEGIN
    SET NOCOUNT ON;
