/*
    Stored Procedure: usp_Parse_Arula_SA_StyleColorReport
    Purpose: Parse Arula SA EDI 850 orders from EDIGatewayInbound and populate StyleColor Report tables
