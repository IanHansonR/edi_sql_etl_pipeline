/*
    Stored Procedure: usp_Parse_Arula_KN_StoreReport
    Purpose: Parse Arula KN EDI 850 orders from EDIGatewayInbound and populate Store Report tables
...
CREATE OR ALTER PROCEDURE dbo.usp_Parse_Arula_KN_StoreReport
AS
BEGIN
    SET NOCOUNT ON;
